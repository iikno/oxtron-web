...
import { buscarEnUsuarios, EliminarUsuario, FormularioUsuario, handleEdit, LimpiarCampos, ObtenerUsuarios, SuspenderUsuario, valoresIniciales  } from './UsuariosService';
...
const Usuarios = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) =>{
            FormularioUsuario(values, edit, imgBuff, usuarios).then(() =>{
                                            ...
                                            usuariosMostrar.map((item) => (
                                                <tr key={item.IdUsuario} className="align-middle">
                                                    ...
                                                    <td className="text-center">
                                                            ...
                                                            <Button variant='outline-warning' onClick={() => {SuspenderUsuario(item.IdUsuario).then(()=> obtenerUsuarios(false))}} title="Suspend">
                                                            ...
                                                            <Button variant='outline-danger' onClick={() => {EliminarUsuario(item.IdUsuario).then(()=>obtenerUsuarios(false)) }} title="Delete">
