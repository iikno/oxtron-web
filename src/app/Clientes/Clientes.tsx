                            ...
                            <Card>
                                <Card.Body>
                                    <Table  className='mb-3' size='sm' responsive  hover>
                                        <thead>
                                            <tr>
                                                <th className='text-center'>{Traducir("clientes.titulo.Foto")}</th>
                                                <th className='text-center'>{Traducir("clientes.titulo.Nombre")}</th>
                                                <th className='text-center'>{Traducir("clientes.titulo.Correo")}</th>
                                                <th className='text-center'>{Traducir("clientes.titulo.Status")}</th>
                                    ...
                                    <tbody>
                                        {
                                            clientesMostrar.map((item) => (
                                                <tr key={item.IdCliente} className="align-middle">
                                        ...
                                        <Col md={7}>
                                            <Tabs defaultActiveKey="datos" id="tabs-cliente" className="mb-3" justify>
                                                <Tab eventKey="datos" title="Datos personales">
                                                        ...
                                                        <input required className='form-control' id='apellidoPaterno' type="text" onChange={formik.handleChange} value={formik.values.apellidoPaterno}/>
                                                        <br></br>
                                                        <label htmlFor='apellidoMaterno'>{Traducir("modal.titulo.apellidoMaterno")}:</label>
                                                        <input required className='form-control' id='apellidoMaterno' type="text" onChange={formik.handleChange} value={formik.values.apellidoMaterno}/>                                                    
                                                        <br></br>
                                                        <Row>
                                                        <Col>
                                                        <label htmlFor='correo'>{Traducir("modal.titulo.correo")}:</label>
                                                        <input required className='form-control' id='correo' type="email" onChange={formik.handleChange} value={formik.values.correo}/>
                                                        </Col>
                                                        <Col>
                                                        ...
                                                        <Row>
                                                            <Col>
                                                                <label htmlFor='empresa'>{Traducir("modal.titulo.empresa")}:</label>
                                                                <input className='form-control' id='empresa' type="text" onChange={formik.handleChange} value={formik.values.empresa}/>
                                                            </Col>
                                                            <Col>
                                                        ...
                                                        <Row>
                                                            <Col>
                                                            <label htmlFor='sucursal'>{Traducir("modal.titulo.sucursal")}:</label>
                                                                <input className='form-control' id='sucursal' type="text" onChange={formik.handleChange} value={formik.values.sucursal}/>
                                                            </Col>
                                                        </Row>
                                                </Tab>
